...
## V2 rebuild
- Split navigation into separate HTML pages.
- Rebuilt shared styling and application logic.
- Rebuilt expense tracker.
- Added Home/Personal expense separation.
- Added One-off/Monthly/Yearly frequencies.
- Added next-month projected cost.
